;require.define({"weinre/client/Client": function(require, exports, module) { var AutoConnect, Binding, Callback, Client, IDGenerator, IDLTools, InspectorBackendImpl, InspectorFrontendHostImpl, MessageDispatcher, RemotePanel, Weinre, WeinreClientEventsImpl, WeinreExtraTargetEventsImpl, installWebInspectorAPIsource;
...
module.exports = Client = (function() {
  ...
  Client.prototype.onLoaded = function() {
    ...
    return messageDispatcher.registerInterface('InspectorFrontendHost', InspectorFrontendHost, false);
  };
